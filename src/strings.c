...
const u8 gText_SaveFileNewer[] = _("The save file was created using a newer\nversion of this hack.\lIt is incompatible with this version.\pPlease install the latest version.\nYour save data has been kept intact.");
const u8 gText_SaveFileInvalid[] = _("The save file appears not to be a valid\nsave for this hack.\pPlease verify you are using a valid save\nfile.");
const u8 gText_SaveFileCannotConv[] = _("The save file was created using an older\nversion of this hack.\pIt cannot be converted to the current\nversion of the game.\pTo play this save file, you must install\nversion {STR_VAR_1}.");
const u8 gText_SaveFileBeginConv[] = _("Converting your save file.\nPlease wait...");
const u8 gText_SaveFileEndConv[] = _("Your save file has been successfully\nconverted to the current version.");
...
const u8 gText_Version_Alpha1[] = _("Alpha 1");
